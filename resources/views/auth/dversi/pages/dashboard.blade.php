            ...
            <div class="card h-100">
                <div class="card-header d-flex align-items-center justify-content-between pb-0">
                    <div class="card-title mb-0">
                        ...
                        <a href="https://drive.google.com/drive/folders/1McBwzuodpBvSVAPj2_0kGXZSUYmX3HQO?usp=sharing" target="_blank" class="btn btn-xs btn-outline-info">
                            Arsip DVERSI
                        </a>
                    </div>
                </div>
                        ...
                        <li class="d-flex mb-4 pb-1">
                            ...
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                                    ...
                                    <small class="text-muted"><i>{{ $data['update_isset'] }}</i></small>
                        ...
                        <li class="d-flex mb-4 pb-1">
                            ...
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                                    ...
                                    <small class="text-muted">{{ $data['update_noset'] }}</small>
                                </div>
                                <div class="user-progress">
