            ...
            <form action="{{ route('kirim') }}" method="POST" class="needs-validation" novalidate>
                ...
                <div class="row input-group">
                    ...
                    <div class="col input-group-prepend">
                        <input type="text" class="datepicker form-control" name="tanggal_lahir" placeholder="..."
                            required>
                ...
                <div class="row input-group">
                    ...
                    <div class="col input-group-prepend">
                        <input type="number" class="form-control rounded" name="lama_studi" placeholder="..."
                            min="1" required />
                ...
                <div class="row input-group mt-1">
                    ...
                    <div class="col input-group">
                        <div id="newRow"></div>
                        <button type="button" onclick="addPencapaian()" class="btn btn-sm btn-success"><i
                                class="fa fa-plus"></i></button>
                        <button type="button" onclick="removePencapaian()" class="btn btn-sm btn-danger"><i
                ...
                <div class="row input-group mt-1">
                    ...
                    <div class="col input-group">
                        ...
                        <button type="button" onclick="addSertifikasi()" class="btn btn-sm btn-success"><i
                                class="fa fa-plus"></i></button>
                        <button type="button" onclick="removeSertifikasi()" class="btn btn-sm btn-danger"><i
                                class="fa fa-minus"></i></button>
                        <br>
                        <br>
                    </div>
                ...
                <div class="row input-group c mb-0">
                    ...
                    <div class="col input-group-prepend">
                        <input type="text" id="inputBeasiswa" class="form-control" name="beasiswa[]"
                ...
                <div class="row input-group mt-1">
                    ...
                    <div class="col input-group">
                        ...
                        <button type="button" onclick="addBeasiswa()" class="btn btn-sm btn-success"><i
                                class="fa fa-plus"></i></button>
                        <button type="button" onclick="removeBeasiswa()" class="btn btn-sm btn-danger"><i
                                class="fa fa-minus"></i></button>
                        <br>
                        <br>
                    </div>
                ...
                <div class="row input-group d mb-0">
                    ...
                    <div class="col input-group-prepend">
                        <input type="text" id="inputOrganisasi" class="form-control" name="organisasi[]"
                ...
                <div class="row input-group mt-1">
                    ...
                    <div class="col input-group">
                        ...
                        <button type="button" onclick="addOrganisasi()" class="btn btn-sm btn-success"><i
                                class="fa fa-plus"></i></button>
                        <button type="button" onclick="removeOrganisasi()" class="btn btn-sm btn-danger"><i
                                class="fa fa-minus"></i></button>
                        <br>
                        <br>
                    </div>
