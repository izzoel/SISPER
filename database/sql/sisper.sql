...
-- Dumping database structure for sisper
CREATE DATABASE IF NOT EXISTS `sisper` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `sisper`;
...
-- Dumping data for table sisper.migrations: ~5 rows (approximately)
...
INSERT INTO `skpi` (`id`, `nama`, `tempat_lahir`, `tanggal_lahir`, `program_studi`, `nim`, `lama_studi`, `tahun_masuk`, `tanggal_lulus`, `judul`, `ijazah`, `toefl`, `pencapaian`, `sertifikasi`, `beasiswa`, `organisasi`, `status_warna`, `status_keterangan`, `created_at`, `updated_at`) VALUES
	(1, 'Admin', 'Banjarbaru', '2023-02-02', 'Sarjana Farmasi', '310117023186', '6', '2029', '2022-12-20', 'lupa', NULL, '400', '', '', '', '', 'warning', 'new', '2023-01-25 00:54:56', '2023-01-25 00:54:56');
